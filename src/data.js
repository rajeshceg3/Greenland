export const locations = [
    {
        ...
        details: {
            ...
            bestTime: "June to September for milder weather and hiking; February to April for northern lights and skiing.",
            logistics: "Direct flights from Copenhagen (CPH) and Reykjavik (KEF). Local transport by bus, taxi, and boat."
        }
    },
    {
        id: 'ilulissat',
        ...
        details: {
            ...
            bestTime: "June to August for midnight sun and whale watching; February to April for dog sledding and icebergs.",
            logistics: "Daily flights from Nuuk and Reykjavik (seasonal). Boat transfers available in summer."
        }
    },
    {
        id: 'scoresby',
        ...
        details: {
            ...
            bestTime: "July to August for expedition cruising; March to April for dog sledding expeditions.",
            logistics: "Accessible primarily by expedition cruise ships in summer or helicopter from Constable Point."
        }
    },
    {
        id: 'kangerlussuaq',
        ...
        details: {
            ...
            climate: "Continental climate with very cold winters and surprisingly warm summers due to its inland location.",
            bestTime: "All year round. Summer for ice sheet tours; Winter for northern lights (very stable weather).",
            logistics: "Main international airport (SFJ) with daily flights from Copenhagen."
        }
    },
    {
        id: 'sisimiut',
        ...
        details: {
            ...
            climate: "Subarctic climate. It is the southernmost town where sled dogs are permitted.",
            bestTime: "Winter for dog sledding and cross-country skiing; Summer for hiking the Arctic Circle Trail.",
            logistics: "Flights from Nuuk and Kangerlussuaq. Coastal ferry (Sarfaq Ittuk) stop."
        }
    },
    {
        id: 'qaqortoq',
        ...
        details: {
            ...
            climate: "Subpolar oceanic climate, milder than the north but with more precipitation.",
            bestTime: "June to September for green hills and iceberg viewing.",
            logistics: "Helicopter from Narsarsuaq. Coastal ferry stop."
        }
    },
    {
        id: 'tasiilaq',
        ...
        details: {
            ...
            climate: "Tundra climate with strong Piteraq winds in winter.",
            bestTime: "July to August for hiking; March to April for dog sledding.",
            logistics: "Helicopter from Kulusuk Airport (which has flights from Reykjavik/Nuuk)."
        }
    },
    {
        id: 'disko',
        ...
        details: {
            ...
            climate: "Arctic climate but with lush vegetation in summer due to volcanic soil.",
            bestTime: "Summer for hiking and whale watching; Winter for dog sledding on sea ice.",
            logistics: "Boat from Ilulissat in summer; Helicopter in winter."
        }
    },
    {
        id: 'uunartoq',
        ...
        details: {
            ...
            climate: "South Greenland climate, but the water is always around 38°C (100°F).",
            bestTime: "Summer is the most popular and accessible time.",
            logistics: "Boat tours from Qaqortoq or Nanortalik."
        }
    },
    {
        id: 'uummannaq',
        ...
        details: {
            ...
            climate: "High Arctic. One of the sunniest places in Greenland.",
            bestTime: "March to May for ice fishing and dog sledding; July to August for the midnight sun.",
            logistics: "Helicopter from Qaarsut Airport."
        }
    },
    {
        id: 'narsarsuaq',
        ...
        details: {
            ...
            climate: "Subarctic with relatively warm summers.",
            bestTime: "Summer for hiking to the Ice Sheet and visiting Brattahlid (Erik the Red's farm).",
            logistics: "International airport with summer flights from Copenhagen and Reykjavik."
        }
    },
    {
        id: 'ittoqqortoormiit',
        ...
        details: {
            ...
            climate: "High Arctic. Sea ice locks the town in for 9 months of the year.",
            bestTime: "April for dog sledding; August for cruise visits.",
            logistics: "Helicopter from Constable Point (Nerlerit Inaat) Airport."
        }
    }
];
